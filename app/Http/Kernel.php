...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'auth.master' => \App\Http\Middleware\RedirectifMaster::class,
        ...
        'active_student' => \App\http\Middleware\IfActiveStudent::class,
        'inactive_student' => \App\http\Middleware\IfNotActiveStudent::class,
