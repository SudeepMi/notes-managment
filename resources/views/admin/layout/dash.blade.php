...
<body class="fixed-nav sticky-footer" id="page-top">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
            <a class="nav-link title" href="#">Admin Dashboard</a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <a class="nav-link" href="{{ route('cpannel.admin.home') }}">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
            <a class="nav-link" href="{{ route('cpannel.admin.teachers') }}">
              <i class="fa fa-fw fa-dashboard"></i>
              <span class="nav-link-text">Teachers</span>
            </a>
          </li>
          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
            <a class="nav-link" href="{{ route('cpannel.admin.students') }}">
              <i class="fa fa-fw fa-dashboard"></i>
  ...
  @yield('content')
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <form id="frm-logout" action="{{ route('cpannel.admin.logout') }}" method="POST" style="display: none;">
                    {{ csrf_field() }}
                </form>
        </div>
        </div>
   ...
   {{--  <!--
    ...
    <scr ipt src="js/admin-charts.js"></script>  --}}
    <script>
