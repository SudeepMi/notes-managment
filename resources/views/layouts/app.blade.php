...
<head>
	...
	<link href="{{ asset('assets/css/icon_fonts/font/all_icons.min.css') }}" rel="stylesheet">
    ...
    <header class="header fadeInDown">
		...
		<ul id="top_menu">
            <li>
               ...
               <a href="#" onclick="event.preventDefault(); document.getElementById('frm-logout').submit();" class="btn_1 rounded">Logout</a>
...
<!--/footer-->
    ...
    <script>
        ...
        $('html').click(function(e) {
            ...
            if (e.target.className != 'login' && $(e.target).parents('.role').length == 0) {
                $(".role").hide();
            }
